...
pub fn post_req(path: &String, domain: &String, port: &String, body: &String, headers: &String, reqs_per_connection: &usize){
...
pub fn tls_post_req(path: &String, domain: &String, port: &String, body: &String, headers: &String, reqs_per_connection: &usize){
    let temp = create_post_request(path,domain,body,headers);
    let request = temp.as_bytes();
